...
const creationDescr = <div>LEGO Technic released the excellent <a href="https://www.lego.com/en-us/service/buildinginstructions/42043" target="_blank" rel="noreferrer">Mercedes-Benz Arocs</a> truck in Aug 2015, and shortly after that, announced a Mercedes-Benz themed competition. The objective: design a Mercedes-Benz truck for the year 2045. My concept was a drone transporter truck, where the drone would be used to track erratic weather patterns caused by global warming. I also imagined a fully electric powertrain with in-hub motors, powered by batteries and ultracapacitors, with autonomous driving capabilities. This was my second LEGO competition after a successful first attempt with the <a href="#/gallery/4x4crawler" target="_blank" rel="noreferrer">4x4 crawler</a>, and although I didn't win any prizes this time, it was still an enjoyable build!</div>;
const creationChips = ["Power Functions", "Contest Submission"];
const info = [
	{
		name: "YouTube",
		type: "Video",

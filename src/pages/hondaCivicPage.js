...
const info = [
	...
	},
	{
		...
		descr: <div>One of the major aesthetic improvements over the previous <a href="#/gallery/sportscar" target="_blank" rel="noreferrer">sports car</a> was to make the wheel size more proportional, by increasing the tire diameter from 30mm to 43mm. I was also pleased with the clean lines of the front wheel arches and the striking gold rims.</div>
	},
	{
		name: "Bottom",
		type: "Photo",
